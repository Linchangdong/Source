    ...
    $.fn.pbTouchSlider = function(options) {
        var slider_Opts = $.extend({
            ...
            slider_Breakpoints : { // Kind of media queries ( can add more if you know how to do it :D and if you need )
                default : {
                    height : 0 //  height on desktop
                },
                tablet : {
                    height : 0, // height on tablet
                    media : 0 // tablet breakpoint
                },
                smartphone : {
                    height : 0, // height on smartphone
                    media : 0 // smartphone breakpoint
                }
            }
        }, options);
        ...
        function setResponsive() {
			...
			if(slider_Opts.slider_Breakpoints.default.height == 0) return;
        ...
        $(window).on('load', function() {
          $(pbSlider.slider_Item).each(function(){
			...
			this.innerHTML = '<img class="sliderplaceholder" src="'+bg+'" />';
          });
          setTimeout ( function(){
              loader(false);
            },1000);
